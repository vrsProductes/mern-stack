...
// Social Box Chart
const RoomMates = [
  {name:'Ashok Golla',date:'12/07/2019',spend:'rice',money:201},
  {name:'Prasad Badugu',date:'12/07/2019',spend:'rice',money:201},
  {name:'Vignesh',date:'12/07/2019',spend:'rice',money:201},
  {name:'Murali Badugu',date:'12/07/2019',spend:'rice',money:201},
  {name:'Venkaiah Badugu',date:'12/07/2019',spend:'rice',money:201},
  {name:'Venkaiah Vempalla',date:'12/07/2019',spend:'rice',money:201},
];
...
class Dashboard extends Component {
  ...
  renderTableData() {
    return this.state.RoomMates.map((student, index) => {
       const { name, date, spend, money } = student //destructuring
       return (
          <tr key={index}>
             <td>{name}</td>
             <td>{date}</td>
    ...
    return (
      <div className="animated fadeIn">
        ...
        <Col>
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i> Room table
              </CardHeader>
              <CardBody>
